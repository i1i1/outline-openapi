...
class AuthConfigPost200ResponseData(BaseModel):
    """
    AuthConfigPost200ResponseData
    """ # noqa: E501
    name: Optional[StrictStr] = None
    hostname: Optional[StrictStr] = None
    services: Optional[List[AuthConfigPost200ResponseDataServicesInner]] = None
    __properties: ClassVar[List[str]] = ["name", "hostname", "services"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "services": [AuthConfigPost200ResponseDataServicesInner.from_dict(_item) for _item in obj["services"]] if obj.get("services") is not None else None
        })
        return _obj
