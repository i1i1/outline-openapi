...
class CollectionsExportPost200ResponseData(BaseModel):
    """
    CollectionsExportPost200ResponseData
    """ # noqa: E501
    file_operation: Optional[FileOperation] = Field(default=None, alias="fileOperation")
    __properties: ClassVar[List[str]] = ["fileOperation"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of file_operation
        if self.file_operation:
            _dict['fileOperation'] = self.file_operation.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "fileOperation": FileOperation.from_dict(obj["fileOperation"]) if obj.get("fileOperation") is not None else None
        })
        return _obj
