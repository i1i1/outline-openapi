...
class User(BaseModel):
    ...
    name: Optional[StrictStr] = Field(default=None, description="The name of this user, it is migrated from Slack or Google Workspace when the SSO connection is made but can be changed if neccessary.")
    avatar_url: Optional[StrictStr] = Field(default=None, description="The URL for the image associated with this user, it will be displayed in the application UI and email notifications.", alias="avatarUrl")
    email: Optional[StrictStr] = Field(default=None, description="The email associated with this user, it is migrated from Slack or Google Workspace when the SSO connection is made but can be changed if neccessary.")
    role: Optional[UserRole] = None
    is_suspended: Optional[StrictBool] = Field(default=None, description="Whether this user has been suspended.", alias="isSuspended")
    last_active_at: Optional[datetime] = Field(default=None, description="The last time this user made an API request, this value is updated at most every 5 minutes.", alias="lastActiveAt")
    created_at: Optional[datetime] = Field(default=None, description="The date and time that this user first signed in or was invited as a guest.", alias="createdAt")
    __properties: ClassVar[List[str]] = ["id", "name", "avatarUrl", "email", "role", "isSuspended", "lastActiveAt", "createdAt"]
