...
class CollectionsGroupMembershipsPost200Response(BaseModel):
    """
    CollectionsGroupMembershipsPost200Response
    """ # noqa: E501
    data: Optional[CollectionsGroupMembershipsPost200ResponseData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": CollectionsGroupMembershipsPost200ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None,
