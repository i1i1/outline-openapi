...
class Share(BaseModel):
    ...
    document_title: Optional[StrictStr] = Field(default=None, description="Title of the shared document.", alias="documentTitle")
    document_url: Optional[StrictStr] = Field(default=None, description="URL of the original document.", alias="documentUrl")
    url: Optional[StrictStr] = Field(default=None, description="URL of the publicly shared document.")
    published: Optional[StrictBool] = Field(default=None, description="If true the share can be loaded without a user account.")
    include_child_documents: Optional[StrictBool] = Field(default=None, description="If to also give permission to view documents nested beneath this one.", alias="includeChildDocuments")
    created_at: Optional[datetime] = Field(default=None, description="Date and time when this share was created", alias="createdAt")
    created_by: Optional[User] = Field(default=None, alias="createdBy")
    updated_at: Optional[datetime] = Field(default=None, description="Date and time when this share was edited", alias="updatedAt")
    last_accessed_at: Optional[datetime] = Field(default=None, description="Date and time when this share was last viewed", alias="lastAccessedAt")
    __properties: ClassVar[List[str]] = ["id", "documentTitle", "documentUrl", "url", "published", "includeChildDocuments", "createdAt", "createdBy", "updatedAt", "lastAccessedAt"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "includeChildDocuments": obj.get("includeChildDocuments"),
