...
class UsersListPostRequest(BaseModel):
    """
    ...
    filter: Optional[StrictStr] = Field(default=None, description="The status to filter by")
    role: Optional[UserRole] = None
    __properties: ClassVar[List[str]] = ["offset", "limit", "sort", "direction", "query", "emails", "filter", "role"]
    ...
    def filter_validate_enum(cls, value):
        ...
        if value not in set(['all', 'invited', 'active', 'suspended']):
            raise ValueError("must be one of enum values ('all', 'invited', 'active', 'suspended')")
        return value
