...
class Event(BaseModel):
    ...
    model_id: Optional[StrictStr] = Field(default=None, description="Identifier for the object this event is associated with when it is not one of document, collection, or user.", alias="modelId")
    actor_id: Optional[StrictStr] = Field(default=None, description="The user that performed the action.", alias="actorId")
    actor_ip_address: Optional[StrictStr] = Field(default=None, description="The ip address the action was performed from. This field is only returned when the `auditLog` boolean is true.", alias="actorIpAddress")
    collection_id: Optional[StrictStr] = Field(default=None, description="Identifier for the associated collection, if any", alias="collectionId")
    document_id: Optional[StrictStr] = Field(default=None, description="Identifier for the associated document, if any", alias="documentId")
    created_at: Optional[datetime] = Field(default=None, description="The date and time that this event was created", alias="createdAt")
    data: Optional[Dict[str, Any]] = Field(default=None, description="Additional unstructured data associated with the event")
    actor: Optional[User] = None
    __properties: ClassVar[List[str]] = ["id", "name", "modelId", "actorId", "actorIpAddress", "collectionId", "documentId", "createdAt", "data", "actor"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "actorIpAddress": obj.get("actorIpAddress"),
