...
class CollectionsExportPost200Response(BaseModel):
    """
    CollectionsExportPost200Response
    """ # noqa: E501
    data: Optional[CollectionsExportPost200ResponseData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": CollectionsExportPost200ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
