...
class Revision(BaseModel):
    ...
    text: Optional[StrictStr] = Field(default=None, description="Body of the document, may contain markdown formatting")
    created_at: Optional[datetime] = Field(default=None, description="Date and time when this revision was created", alias="createdAt")
    created_by: Optional[User] = Field(default=None, alias="createdBy")
    __properties: ClassVar[List[str]] = ["id", "documentId", "title", "text", "createdAt", "createdBy"]
