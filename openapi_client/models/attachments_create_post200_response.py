...
class AttachmentsCreatePost200Response(BaseModel):
    """
    AttachmentsCreatePost200Response
    """ # noqa: E501
    data: Optional[AttachmentsCreatePost200ResponseData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": AttachmentsCreatePost200ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
