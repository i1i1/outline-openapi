...
class FileOperation(BaseModel):
    ...
    type: Optional[StrictStr] = Field(default=None, description="The type of file operation.")
    state: Optional[StrictStr] = Field(default=None, description="The state of the file operation.")
    collection: Optional[FileOperationCollection] = None
    user: Optional[User] = None
    size: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The size of the resulting file in bytes")
    ...
    __properties: ClassVar[List[str]] = ["id", "type", "state", "collection", "user", "size", "createdAt"]
    ...
    def state_validate_enum(cls, value):
        ...
        if value not in set(['creating', 'uploading', 'complete', 'error', 'expired']):
            raise ValueError("must be one of enum values ('creating', 'uploading', 'complete', 'error', 'expired')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type"),
            "state": obj.get("state"),
            "collection": FileOperationCollection.from_dict(obj["collection"]) if obj.get("collection") is not None else None,
