...
class NavigationNode(BaseModel):
    ...
    NavigationNode
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Unique identifier for the document.")
    title: Optional[StrictStr] = None
    url: Optional[StrictStr] = None
    children: Optional[List[NavigationNode]] = None
    __properties: ClassVar[List[str]] = ["id", "title", "url", "children"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "title": obj.get("title"),
            "url": obj.get("url"),
            "children": [NavigationNode.from_dict(_item) for _item in obj["children"]] if obj.get("children") is not None else None
        })
        return _obj

# TODO: Rewrite to not use raise_errors
NavigationNode.model_rebuild(raise_errors=False)
