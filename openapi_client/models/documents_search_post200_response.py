...
class DocumentsSearchPost200Response(BaseModel):
    """
    DocumentsSearchPost200Response
    """ # noqa: E501
    data: Optional[List[DocumentsSearchPost200ResponseDataInner]] = None
    policies: Optional[List[Policy]] = None
    pagination: Optional[Pagination] = None
    __properties: ClassVar[List[str]] = ["data", "policies", "pagination"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [DocumentsSearchPost200ResponseDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
