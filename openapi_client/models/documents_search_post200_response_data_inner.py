...
class DocumentsSearchPost200ResponseDataInner(BaseModel):
    """
    DocumentsSearchPost200ResponseDataInner
    """ # noqa: E501
    context: Optional[StrictStr] = Field(default=None, description="A short snippet of context from the document that includes the search query.")
    ranking: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The ranking used to order search results based on relevance.")
    document: Optional[Document] = None
    __properties: ClassVar[List[str]] = ["context", "ranking", "document"]
