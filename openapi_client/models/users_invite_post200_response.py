...
class UsersInvitePost200Response(BaseModel):
    """
    UsersInvitePost200Response
    """ # noqa: E501
    sent: Optional[List[Invite]] = None
    users: Optional[List[User]] = None
    __properties: ClassVar[List[str]] = ["sent", "users"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "sent": [Invite.from_dict(_item) for _item in obj["sent"]] if obj.get("sent") is not None else None,
