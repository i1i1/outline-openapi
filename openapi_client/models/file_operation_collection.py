...
class FileOperationCollection(BaseModel):
    """
    ...
    icon: Optional[StrictStr] = Field(default=None, description="A string that represents an icon in the outline-icons package")
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "description", "sort", "index", "color", "icon", "permission", "createdAt", "updatedAt", "deletedAt"]
