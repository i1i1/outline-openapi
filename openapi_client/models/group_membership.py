...
class GroupMembership(BaseModel):
    ...
    group_id: Optional[StrictStr] = Field(default=None, description="Identifier for the associated group.", alias="groupId")
    user_id: Optional[StrictStr] = Field(default=None, description="Identifier for the associated user.", alias="userId")
    user: Optional[User] = None
    __properties: ClassVar[List[str]] = ["id", "groupId", "userId", "user"]
