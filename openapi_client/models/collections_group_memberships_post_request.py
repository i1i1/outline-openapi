...
class CollectionsGroupMembershipsPostRequest(BaseModel):
    """
    ...
    id: StrictStr = Field(description="Identifier for the collection")
    query: Optional[StrictStr] = Field(default=None, description="Filter memberships by group names")
    permission: Optional[Permission] = None
    __properties: ClassVar[List[str]] = ["offset", "limit", "id", "query", "permission"]
