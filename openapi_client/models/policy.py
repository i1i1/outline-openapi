...
class Policy(BaseModel):
    ...
    Policy
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Unique identifier for the object this policy references.")
    abilities: Optional[PolicyAbilities] = None
    __properties: ClassVar[List[str]] = ["id", "abilities"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of abilities
        if self.abilities:
            _dict['abilities'] = self.abilities.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "abilities": PolicyAbilities.from_dict(obj["abilities"]) if obj.get("abilities") is not None else None
        })
        return _obj
