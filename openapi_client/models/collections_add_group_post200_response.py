...
class CollectionsAddGroupPost200Response(BaseModel):
    """
    CollectionsAddGroupPost200Response
    """ # noqa: E501
    data: Optional[CollectionsAddGroupPost200ResponseData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": CollectionsAddGroupPost200ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
