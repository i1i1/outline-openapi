...
class DocumentsSearchPostRequest(BaseModel):
    """
    ...
    user_id: Optional[StrictStr] = Field(default=None, description="Any documents that have not been edited by the user identifier will be filtered out", alias="userId")
    collection_id: Optional[StrictStr] = Field(default=None, description="A collection to search within", alias="collectionId")
    include_archived: Optional[StrictBool] = Field(default=None, alias="includeArchived")
    include_drafts: Optional[StrictBool] = Field(default=None, alias="includeDrafts")
    ...
    __properties: ClassVar[List[str]] = ["offset", "limit", "query", "userId", "collectionId", "includeArchived", "includeDrafts", "dateFilter"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "includeArchived": obj.get("includeArchived"),
            "includeDrafts": obj.get("includeDrafts"),
