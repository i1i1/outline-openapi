...
class CollectionsGroupMembershipsPost200ResponseData(BaseModel):
    """
    CollectionsGroupMembershipsPost200ResponseData
    """ # noqa: E501
    groups: Optional[List[Group]] = None
    collection_group_memberships: Optional[List[CollectionGroupMembership]] = Field(default=None, alias="collectionGroupMemberships")
    __properties: ClassVar[List[str]] = ["groups", "collectionGroupMemberships"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.groups:
            ...
            _dict['groups'] = _items
        # override the default output from pydantic by calling `to_dict()` of each item in collection_group_memberships (list)
        _items = []
        if self.collection_group_memberships:
            for _item in self.collection_group_memberships:
                if _item:
                    _items.append(_item.to_dict())
            _dict['collectionGroupMemberships'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "collectionGroupMemberships": [CollectionGroupMembership.from_dict(_item) for _item in obj["collectionGroupMemberships"]] if obj.get("collectionGroupMemberships") is not None else None
        })
        return _obj
