...
class View(BaseModel):
    ...
    document_id: Optional[StrictStr] = Field(default=None, description="Identifier for the associated document.", alias="documentId")
    first_viewed_at: Optional[datetime] = Field(default=None, description="When the document was first viewed by the user", alias="firstViewedAt")
    last_viewed_at: Optional[datetime] = Field(default=None, description="When the document was last viewed by the user", alias="lastViewedAt")
    count: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The number of times the user has viewed the document.")
    user: Optional[User] = None
    __properties: ClassVar[List[str]] = ["id", "documentId", "firstViewedAt", "lastViewedAt", "count", "user"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "firstViewedAt": obj.get("firstViewedAt"),
