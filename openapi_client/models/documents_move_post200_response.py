...
class DocumentsMovePost200Response(BaseModel):
    """
    DocumentsMovePost200Response
    """ # noqa: E501
    data: Optional[DocumentsMovePost200ResponseData] = None
    policies: Optional[List[Policy]] = None
    __properties: ClassVar[List[str]] = ["data", "policies"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": DocumentsMovePost200ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None,
