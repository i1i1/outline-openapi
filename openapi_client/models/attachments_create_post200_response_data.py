...
class AttachmentsCreatePost200ResponseData(BaseModel):
    """
    AttachmentsCreatePost200ResponseData
    """ # noqa: E501
    max_upload_size: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="maxUploadSize")
    upload_url: Optional[StrictStr] = Field(default=None, alias="uploadUrl")
    form: Optional[Dict[str, Any]] = None
    attachment: Optional[Attachment] = None
    __properties: ClassVar[List[str]] = ["maxUploadSize", "uploadUrl", "form", "attachment"]
