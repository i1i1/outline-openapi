...
class AuthConfigPost200Response(BaseModel):
    """
    AuthConfigPost200Response
    """ # noqa: E501
    data: Optional[AuthConfigPost200ResponseData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": AuthConfigPost200ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
