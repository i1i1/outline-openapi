...
class Comment(BaseModel):
    ...
    data: Optional[Dict[str, Any]] = Field(default=None, description="The editor data representing this comment.")
    document_id: Optional[StrictStr] = Field(default=None, description="Identifier for the document this is related to.", alias="documentId")
    parent_comment_id: Optional[StrictStr] = Field(default=None, description="Identifier for the comment this is a child of, if any.", alias="parentCommentId")
    ...
    __properties: ClassVar[List[str]] = ["id", "data", "documentId", "parentCommentId", "createdAt", "createdBy", "updatedAt", "updatedBy"]
