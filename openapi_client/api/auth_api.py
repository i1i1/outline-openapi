...
class AuthApi:
    ...
    def auth_config_post(
        ...
        _param = self._auth_config_post_serialize(
    ...
    @validate_call
    def auth_config_post_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AuthConfigPost200Response]:
        """Retrieve auth config
    ...
    @validate_call
    def auth_config_post_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _auth_config_post_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    def auth_info_post(
        ...
        _param = self._auth_info_post_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def auth_info_post_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AuthInfoPost200Response]:
        """Retrieve auth
    ...
    @validate_call
    def auth_info_post_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
