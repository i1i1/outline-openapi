...
class CommentsApi:
    ...
    @validate_call
    def comments_create_post(
        self,
        comments_create_post_request: Optional[CommentsCreatePostRequest] = None,
        ...
        :param comments_create_post_request:
        :type comments_create_post_request: CommentsCreatePostRequest
        ...
        _param = self._comments_create_post_serialize(
            comments_create_post_request=comments_create_post_request,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "CommentsCreatePost200Response",
            '401': "Error",
            '403': "Error",
            '404': "Error",
        }
    ...
    @validate_call
    def comments_create_post_with_http_info(
        self,
        comments_create_post_request: Optional[CommentsCreatePostRequest] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CommentsCreatePost200Response]:
        """Create a comment
    ...
    @validate_call
    def comments_create_post_without_preload_content(
        self,
        comments_create_post_request: Optional[CommentsCreatePostRequest] = None,
        _request_timeout: Union[
            None,
    ...
    def _comments_create_post_serialize(
        self,
        comments_create_post_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if comments_create_post_request is not None:
            _body_params = comments_create_post_request
    ...
    def comments_delete_post(
        ...
        _param = self._comments_delete_post_serialize(
    ...
    @validate_call
    def comments_delete_post_with_http_info(
        self,
        collections_delete_post_request: Optional[CollectionsDeletePostRequest] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def comments_delete_post_without_preload_content(
        self,
        collections_delete_post_request: Optional[CollectionsDeletePostRequest] = None,
        _request_timeout: Union[
            None,
    ...
    def _comments_delete_post_serialize(
        self,
    ...
    @validate_call
    def comments_list_post(
        self,
        comments_list_post_request: Optional[CommentsListPostRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param comments_list_post_request:
        :type comments_list_post_request: CommentsListPostRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._comments_list_post_serialize(
            comments_list_post_request=comments_list_post_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def comments_list_post_with_http_info(
        self,
        comments_list_post_request: Optional[CommentsListPostRequest] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def comments_list_post_without_preload_content(
        self,
        comments_list_post_request: Optional[CommentsListPostRequest] = None,
        _request_timeout: Union[
            None,
    ...
    def _comments_list_post_serialize(
        self,
        comments_list_post_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if comments_list_post_request is not None:
            _body_params = comments_list_post_request
    ...
    @validate_call
    def comments_update_post(
        self,
        comments_update_post_request: Optional[CommentsUpdatePostRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param comments_update_post_request:
        :type comments_update_post_request: CommentsUpdatePostRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._comments_update_post_serialize(
            comments_update_post_request=comments_update_post_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def comments_update_post_with_http_info(
        self,
        comments_update_post_request: Optional[CommentsUpdatePostRequest] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def comments_update_post_without_preload_content(
        self,
        comments_update_post_request: Optional[CommentsUpdatePostRequest] = None,
        _request_timeout: Union[
            None,
    ...
    def _comments_update_post_serialize(
        self,
        comments_update_post_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if comments_update_post_request is not None:
            _body_params = comments_update_post_request
