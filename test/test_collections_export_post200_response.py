...
class TestCollectionsExportPost200Response(unittest.TestCase):
    """CollectionsExportPost200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CollectionsExportPost200Response:
        """Test CollectionsExportPost200Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CollectionsExportPost200Response`
        """
        model = CollectionsExportPost200Response()
        if include_optional:
            return CollectionsExportPost200Response(
                data = openapi_client.models._collections_export_post_200_response_data._collections_export_post_200_response_data(
                    file_operation = openapi_client.models.file_operation.FileOperation(
                        id = '', 
                        type = 'export', 
                        state = 'complete', 
                        collection = null, 
    ...
    def testCollectionsExportPost200Response(self):
        """Test CollectionsExportPost200Response"""
