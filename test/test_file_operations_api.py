...
class TestFileOperationsApi(unittest.TestCase):
    ...
    def test_file_operations_delete_post(self) -> None:
    ...
    def test_file_operations_info_post(self) -> None:
    ...
    def test_file_operations_list_post(self) -> None:
    ...
    def test_file_operations_redirect_post(self) -> None:
