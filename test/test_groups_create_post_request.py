...
class TestGroupsCreatePostRequest(unittest.TestCase):
    """GroupsCreatePostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GroupsCreatePostRequest:
        """Test GroupsCreatePostRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GroupsCreatePostRequest`
        """
        model = GroupsCreatePostRequest()
        if include_optional:
            return GroupsCreatePostRequest(
                name = 'Designers'
            )
        else:
            return GroupsCreatePostRequest(
    ...
    def testGroupsCreatePostRequest(self):
        """Test GroupsCreatePostRequest"""
