...
class TestDocumentsViewedPostRequest(unittest.TestCase):
    """DocumentsViewedPostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentsViewedPostRequest:
        """Test DocumentsViewedPostRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentsViewedPostRequest`
        """
        model = DocumentsViewedPostRequest()
        if include_optional:
            return DocumentsViewedPostRequest(
                offset = 1.337,
                limit = 25,
                sort = 'updatedAt',
                direction = 'DESC'
    ...
    def testDocumentsViewedPostRequest(self):
        """Test DocumentsViewedPostRequest"""
