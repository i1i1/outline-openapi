...
class TestFileOperationCollection(unittest.TestCase):
    """FileOperationCollection unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FileOperationCollection:
        """Test FileOperationCollection
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FileOperationCollection`
        """
        model = FileOperationCollection()
        if include_optional:
            return FileOperationCollection(
                id = '',
    ...
    def testFileOperationCollection(self):
        """Test FileOperationCollection"""
