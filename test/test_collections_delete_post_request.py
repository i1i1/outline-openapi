...
class TestCollectionsDeletePostRequest(unittest.TestCase):
    """CollectionsDeletePostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CollectionsDeletePostRequest:
        """Test CollectionsDeletePostRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CollectionsDeletePostRequest`
        """
        model = CollectionsDeletePostRequest()
        if include_optional:
            return CollectionsDeletePostRequest(
                id = ''
            )
        else:
            return CollectionsDeletePostRequest(
    ...
    def testCollectionsDeletePostRequest(self):
        """Test CollectionsDeletePostRequest"""
