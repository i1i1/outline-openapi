...
class TestDocumentsInfoPostRequest(unittest.TestCase):
    """DocumentsInfoPostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentsInfoPostRequest:
        """Test DocumentsInfoPostRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentsInfoPostRequest`
        """
        model = DocumentsInfoPostRequest()
        if include_optional:
            return DocumentsInfoPostRequest(
                id = '',
                share_id = ''
            )
        else:
    ...
    def testDocumentsInfoPostRequest(self):
        """Test DocumentsInfoPostRequest"""
