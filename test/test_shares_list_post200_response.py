...
class TestSharesListPost200Response(unittest.TestCase):
    """SharesListPost200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SharesListPost200Response:
        """Test SharesListPost200Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SharesListPost200Response`
        """
        model = SharesListPost200Response()
        if include_optional:
            return SharesListPost200Response(
                data = [
                    openapi_client.models.share.Share(
                        id = '', 
                        document_title = 'React best practices', 
                        document_url = '', 
                        url = '', 
                        published = False, 
    ...
    def testSharesListPost200Response(self):
        """Test SharesListPost200Response"""
