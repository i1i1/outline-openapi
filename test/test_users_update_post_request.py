...
class TestUsersUpdatePostRequest(unittest.TestCase):
    """UsersUpdatePostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UsersUpdatePostRequest:
        """Test UsersUpdatePostRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UsersUpdatePostRequest`
        """
        model = UsersUpdatePostRequest()
        if include_optional:
            return UsersUpdatePostRequest(
                name = '',
                language = '',
                avatar_url = ''
            )
    ...
    def testUsersUpdatePostRequest(self):
        """Test UsersUpdatePostRequest"""
