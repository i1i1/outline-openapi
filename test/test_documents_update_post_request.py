...
class TestDocumentsUpdatePostRequest(unittest.TestCase):
    """DocumentsUpdatePostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentsUpdatePostRequest:
        """Test DocumentsUpdatePostRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentsUpdatePostRequest`
        """
        model = DocumentsUpdatePostRequest()
        if include_optional:
            return DocumentsUpdatePostRequest(
                id = 'hDYep1TPAM',
                title = '',
                text = '…',
                append = True,
    ...
    def testDocumentsUpdatePostRequest(self):
        """Test DocumentsUpdatePostRequest"""
