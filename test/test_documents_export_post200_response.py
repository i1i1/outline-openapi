...
class TestDocumentsExportPost200Response(unittest.TestCase):
    """DocumentsExportPost200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentsExportPost200Response:
        """Test DocumentsExportPost200Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentsExportPost200Response`
        """
        model = DocumentsExportPost200Response()
        if include_optional:
            return DocumentsExportPost200Response(
                data = ''
            )
        else:
            return DocumentsExportPost200Response(
    ...
    def testDocumentsExportPost200Response(self):
        """Test DocumentsExportPost200Response"""
