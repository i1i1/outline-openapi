...
class TestDocumentsExportPostRequest(unittest.TestCase):
    """DocumentsExportPostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentsExportPostRequest:
        """Test DocumentsExportPostRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentsExportPostRequest`
        """
        model = DocumentsExportPostRequest()
        if include_optional:
            return DocumentsExportPostRequest(
                id = ''
            )
        else:
            return DocumentsExportPostRequest(
    ...
    def testDocumentsExportPostRequest(self):
        """Test DocumentsExportPostRequest"""
