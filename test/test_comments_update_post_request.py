...
class TestCommentsUpdatePostRequest(unittest.TestCase):
    """CommentsUpdatePostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CommentsUpdatePostRequest:
        """Test CommentsUpdatePostRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CommentsUpdatePostRequest`
        """
        model = CommentsUpdatePostRequest()
        if include_optional:
            return CommentsUpdatePostRequest(
                id = '',
                data = None
            )
        else:
    ...
    def testCommentsUpdatePostRequest(self):
        """Test CommentsUpdatePostRequest"""
