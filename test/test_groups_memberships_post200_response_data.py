...
class TestGroupsMembershipsPost200ResponseData(unittest.TestCase):
    """GroupsMembershipsPost200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GroupsMembershipsPost200ResponseData:
        """Test GroupsMembershipsPost200ResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GroupsMembershipsPost200ResponseData`
        """
        model = GroupsMembershipsPost200ResponseData()
        if include_optional:
            return GroupsMembershipsPost200ResponseData(
                users = [
    ...
    def testGroupsMembershipsPost200ResponseData(self):
        """Test GroupsMembershipsPost200ResponseData"""
