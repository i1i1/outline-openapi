...
class TestGroupsInfoPostRequest(unittest.TestCase):
    """GroupsInfoPostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GroupsInfoPostRequest:
        """Test GroupsInfoPostRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GroupsInfoPostRequest`
        """
        model = GroupsInfoPostRequest()
        if include_optional:
            return GroupsInfoPostRequest(
                id = ''
            )
        else:
            return GroupsInfoPostRequest(
    ...
    def testGroupsInfoPostRequest(self):
        """Test GroupsInfoPostRequest"""
