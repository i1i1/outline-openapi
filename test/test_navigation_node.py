...
class TestNavigationNode(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> NavigationNode:
        """Test NavigationNode
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NavigationNode`
        """
        ...
        if include_optional:
            return NavigationNode(
                ...
                url = '',
                children = [
                    openapi_client.models.navigation_node.NavigationNode(
                        id = '', 
                        title = '', 
                        url = '', 
                        children = [
