...
class TestDocumentsApi(unittest.TestCase):
    ...
    def test_documents_archive_post(self) -> None:
    ...
    def test_documents_create_post(self) -> None:
    ...
    def test_documents_delete_post(self) -> None:
    ...
    def test_documents_drafts_post(self) -> None:
    ...
    def test_documents_export_post(self) -> None:
    ...
    def test_documents_import_post(self) -> None:
    ...
    def test_documents_info_post(self) -> None:
    ...
    def test_documents_list_post(self) -> None:
    ...
    def test_documents_move_post(self) -> None:
    ...
    def test_documents_restore_post(self) -> None:
    ...
    def test_documents_search_post(self) -> None:
    ...
    def test_documents_star_post(self) -> None:
    ...
    def test_documents_templatize_post(self) -> None:
    ...
    def test_documents_unpublish_post(self) -> None:
    ...
    def test_documents_unstar_post(self) -> None:
    ...
    def test_documents_update_post(self) -> None:
    ...
    def test_documents_viewed_post(self) -> None:
