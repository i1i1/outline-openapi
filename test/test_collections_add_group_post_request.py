...
class TestCollectionsAddGroupPostRequest(unittest.TestCase):
    """CollectionsAddGroupPostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CollectionsAddGroupPostRequest:
        """Test CollectionsAddGroupPostRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CollectionsAddGroupPostRequest`
        """
        model = CollectionsAddGroupPostRequest()
        if include_optional:
            return CollectionsAddGroupPostRequest(
                id = '',
                group_id = '',
                permission = 'read'
            )
    ...
    def testCollectionsAddGroupPostRequest(self):
        """Test CollectionsAddGroupPostRequest"""
