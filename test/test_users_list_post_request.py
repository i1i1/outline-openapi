...
class TestUsersListPostRequest(unittest.TestCase):
    """UsersListPostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UsersListPostRequest:
        """Test UsersListPostRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UsersListPostRequest`
        """
        model = UsersListPostRequest()
        if include_optional:
            return UsersListPostRequest(
                offset = 1.337,
                limit = 25,
                sort = 'updatedAt',
                direction = 'DESC',
                query = 'jane',
                emails = [
                    '["jane.crandall@mail.com","prudence.crandall@mail.com"]'
                    ],
                filter = 'all',
                role = 'admin'
            )
    ...
    def testUsersListPostRequest(self):
        """Test UsersListPostRequest"""
