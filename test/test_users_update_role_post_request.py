...
class TestUsersUpdateRolePostRequest(unittest.TestCase):
    """UsersUpdateRolePostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UsersUpdateRolePostRequest:
        """Test UsersUpdateRolePostRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UsersUpdateRolePostRequest`
        """
        model = UsersUpdateRolePostRequest()
        if include_optional:
            return UsersUpdateRolePostRequest(
                id = '',
                role = 'admin'
            )
        else:
    ...
    def testUsersUpdateRolePostRequest(self):
        """Test UsersUpdateRolePostRequest"""
