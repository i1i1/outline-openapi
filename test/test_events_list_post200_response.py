...
class TestEventsListPost200Response(unittest.TestCase):
    """EventsListPost200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EventsListPost200Response:
        """Test EventsListPost200Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EventsListPost200Response`
        """
        model = EventsListPost200Response()
        if include_optional:
            return EventsListPost200Response(
                data = [
                    openapi_client.models.event.Event(
                        ...
                        model_id = '', 
                        actor_id = '', 
                        actor_ip_address = '60.169.88.100', 
                        collection_id = '', 
                        document_id = '', 
                        created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        data = {"name":"Equipment list"}, 
                        actor = openapi_client.models.user.User(
                            id = '', 
                            name = 'Jane Doe', 
                            avatar_url = '', 
                            email = '', 
    ...
    def testEventsListPost200Response(self):
        """Test EventsListPost200Response"""
