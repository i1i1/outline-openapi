...
class TestUsersInfoPostRequest(unittest.TestCase):
    """UsersInfoPostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UsersInfoPostRequest:
        """Test UsersInfoPostRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UsersInfoPostRequest`
        """
        model = UsersInfoPostRequest()
        if include_optional:
            return UsersInfoPostRequest(
                id = ''
            )
        else:
            return UsersInfoPostRequest(
    ...
    def testUsersInfoPostRequest(self):
        """Test UsersInfoPostRequest"""
