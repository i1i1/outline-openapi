...
class TestDocumentsCreatePost200Response(unittest.TestCase):
    """DocumentsCreatePost200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentsCreatePost200Response:
        """Test DocumentsCreatePost200Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentsCreatePost200Response`
        """
        model = DocumentsCreatePost200Response()
        if include_optional:
            return DocumentsCreatePost200Response(
                data = openapi_client.models.document.Document(
                    id = '', 
                    collection_id = '', 
                    parent_document_id = '', 
    ...
    def testDocumentsCreatePost200Response(self):
        """Test DocumentsCreatePost200Response"""
