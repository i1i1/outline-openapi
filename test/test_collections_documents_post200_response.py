...
class TestCollectionsDocumentsPost200Response(unittest.TestCase):
    """CollectionsDocumentsPost200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CollectionsDocumentsPost200Response:
        """Test CollectionsDocumentsPost200Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CollectionsDocumentsPost200Response`
        """
        model = CollectionsDocumentsPost200Response()
        if include_optional:
            return CollectionsDocumentsPost200Response(
                data = []
            )
        else:
            return CollectionsDocumentsPost200Response(
    ...
    def testCollectionsDocumentsPost200Response(self):
        """Test CollectionsDocumentsPost200Response"""
