...
class TestCommentsCreatePostRequest(unittest.TestCase):
    """CommentsCreatePostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CommentsCreatePostRequest:
        """Test CommentsCreatePostRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CommentsCreatePostRequest`
        """
        model = CommentsCreatePostRequest()
        if include_optional:
            return CommentsCreatePostRequest(
                id = '',
                document_id = '',
                parent_comment_id = '',
                data = None
    ...
    def testCommentsCreatePostRequest(self):
        """Test CommentsCreatePostRequest"""
