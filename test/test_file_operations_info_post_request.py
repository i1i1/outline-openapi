...
class TestFileOperationsInfoPostRequest(unittest.TestCase):
    """FileOperationsInfoPostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FileOperationsInfoPostRequest:
        """Test FileOperationsInfoPostRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FileOperationsInfoPostRequest`
        """
        model = FileOperationsInfoPostRequest()
        if include_optional:
            return FileOperationsInfoPostRequest(
                id = ''
            )
        else:
            return FileOperationsInfoPostRequest(
    ...
    def testFileOperationsInfoPostRequest(self):
        """Test FileOperationsInfoPostRequest"""
