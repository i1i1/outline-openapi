...
class TestCollectionsInfoPostRequest(unittest.TestCase):
    """CollectionsInfoPostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CollectionsInfoPostRequest:
        """Test CollectionsInfoPostRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CollectionsInfoPostRequest`
        """
        model = CollectionsInfoPostRequest()
        if include_optional:
            return CollectionsInfoPostRequest(
                id = ''
            )
        else:
            return CollectionsInfoPostRequest(
    ...
    def testCollectionsInfoPostRequest(self):
        """Test CollectionsInfoPostRequest"""
