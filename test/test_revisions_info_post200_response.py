...
class TestRevisionsInfoPost200Response(unittest.TestCase):
    """RevisionsInfoPost200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RevisionsInfoPost200Response:
        """Test RevisionsInfoPost200Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RevisionsInfoPost200Response`
        """
        model = RevisionsInfoPost200Response()
        if include_optional:
            return RevisionsInfoPost200Response(
                data = openapi_client.models.revision.Revision(
                    id = '', 
                    document_id = '', 
                    title = '', 
                    text = '', 
    ...
    def testRevisionsInfoPost200Response(self):
        """Test RevisionsInfoPost200Response"""
