...
class TestAttachmentsCreatePostRequest(unittest.TestCase):
    """AttachmentsCreatePostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AttachmentsCreatePostRequest:
        """Test AttachmentsCreatePostRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AttachmentsCreatePostRequest`
        """
        model = AttachmentsCreatePostRequest()
        if include_optional:
            return AttachmentsCreatePostRequest(
                name = 'image.png',
                document_id = '',
    ...
    def testAttachmentsCreatePostRequest(self):
        """Test AttachmentsCreatePostRequest"""
