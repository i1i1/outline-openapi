...
class TestFileOperationsInfoPost200Response(unittest.TestCase):
    """FileOperationsInfoPost200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FileOperationsInfoPost200Response:
        """Test FileOperationsInfoPost200Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FileOperationsInfoPost200Response`
        """
        model = FileOperationsInfoPost200Response()
        if include_optional:
            return FileOperationsInfoPost200Response(
                data = openapi_client.models.file_operation.FileOperation(
                    id = '', 
                    type = 'export', 
                    state = 'complete', 
                    collection = null, 
    ...
    def testFileOperationsInfoPost200Response(self):
        """Test FileOperationsInfoPost200Response"""
