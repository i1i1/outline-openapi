...
class TestCollectionsGroupMembershipsPost200Response(unittest.TestCase):
    """CollectionsGroupMembershipsPost200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CollectionsGroupMembershipsPost200Response:
        """Test CollectionsGroupMembershipsPost200Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CollectionsGroupMembershipsPost200Response`
        """
        model = CollectionsGroupMembershipsPost200Response()
        if include_optional:
            return CollectionsGroupMembershipsPost200Response(
                data = openapi_client.models._collections_group_memberships_post_200_response_data._collections_group_memberships_post_200_response_data(
                    groups = [
                    ...
                    collection_group_memberships = [
                        openapi_client.models.collection_group_membership.CollectionGroupMembership(
                            id = '', 
                            group_id = '', 
                            collection_id = '', 
                            permission = 'read', )
    ...
    def testCollectionsGroupMembershipsPost200Response(self):
        """Test CollectionsGroupMembershipsPost200Response"""
