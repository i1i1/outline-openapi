...
class TestDocumentsMovePostRequest(unittest.TestCase):
    """DocumentsMovePostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentsMovePostRequest:
        """Test DocumentsMovePostRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentsMovePostRequest`
        """
        model = DocumentsMovePostRequest()
        if include_optional:
            return DocumentsMovePostRequest(
                id = 'hDYep1TPAM',
                collection_id = '',
                parent_document_id = ''
            )
    ...
    def testDocumentsMovePostRequest(self):
        """Test DocumentsMovePostRequest"""
