...
class TestDocumentsCreatePostRequest(unittest.TestCase):
    """DocumentsCreatePostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentsCreatePostRequest:
        """Test DocumentsCreatePostRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentsCreatePostRequest`
        """
        model = DocumentsCreatePostRequest()
        if include_optional:
            return DocumentsCreatePostRequest(
    ...
    def testDocumentsCreatePostRequest(self):
        """Test DocumentsCreatePostRequest"""
