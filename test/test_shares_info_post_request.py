...
class TestSharesInfoPostRequest(unittest.TestCase):
    """SharesInfoPostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SharesInfoPostRequest:
        """Test SharesInfoPostRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SharesInfoPostRequest`
        """
        model = SharesInfoPostRequest()
        if include_optional:
            return SharesInfoPostRequest(
                id = '',
                document_id = ''
            )
        else:
    ...
    def testSharesInfoPostRequest(self):
        """Test SharesInfoPostRequest"""
