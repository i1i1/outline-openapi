...
class TestCollectionsRemoveGroupPostRequest(unittest.TestCase):
    """CollectionsRemoveGroupPostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CollectionsRemoveGroupPostRequest:
        """Test CollectionsRemoveGroupPostRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CollectionsRemoveGroupPostRequest`
        """
        model = CollectionsRemoveGroupPostRequest()
        if include_optional:
            return CollectionsRemoveGroupPostRequest(
                id = '',
                group_id = ''
            )
        else:
    ...
    def testCollectionsRemoveGroupPostRequest(self):
        """Test CollectionsRemoveGroupPostRequest"""
