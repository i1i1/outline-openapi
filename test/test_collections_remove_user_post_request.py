...
class TestCollectionsRemoveUserPostRequest(unittest.TestCase):
    """CollectionsRemoveUserPostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CollectionsRemoveUserPostRequest:
        """Test CollectionsRemoveUserPostRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CollectionsRemoveUserPostRequest`
        """
        model = CollectionsRemoveUserPostRequest()
        if include_optional:
            return CollectionsRemoveUserPostRequest(
                id = '',
                user_id = ''
            )
        else:
    ...
    def testCollectionsRemoveUserPostRequest(self):
        """Test CollectionsRemoveUserPostRequest"""
