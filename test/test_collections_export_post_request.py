...
class TestCollectionsExportPostRequest(unittest.TestCase):
    """CollectionsExportPostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CollectionsExportPostRequest:
        """Test CollectionsExportPostRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CollectionsExportPostRequest`
        """
        model = CollectionsExportPostRequest()
        if include_optional:
            return CollectionsExportPostRequest(
    ...
    def testCollectionsExportPostRequest(self):
        """Test CollectionsExportPostRequest"""
