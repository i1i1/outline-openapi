...
class TestAuthConfigPost200ResponseData(unittest.TestCase):
    """AuthConfigPost200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AuthConfigPost200ResponseData:
        """Test AuthConfigPost200ResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuthConfigPost200ResponseData`
        """
        model = AuthConfigPost200ResponseData()
        if include_optional:
            return AuthConfigPost200ResponseData(
                name = 'Acme Inc',
    ...
    def testAuthConfigPost200ResponseData(self):
        """Test AuthConfigPost200ResponseData"""
