...
class TestCollectionsCreatePostRequest(unittest.TestCase):
    """CollectionsCreatePostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CollectionsCreatePostRequest:
        """Test CollectionsCreatePostRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CollectionsCreatePostRequest`
        """
        model = CollectionsCreatePostRequest()
        if include_optional:
            return CollectionsCreatePostRequest(
    ...
    def testCollectionsCreatePostRequest(self):
        """Test CollectionsCreatePostRequest"""
