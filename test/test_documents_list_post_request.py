...
class TestDocumentsListPostRequest(unittest.TestCase):
    """DocumentsListPostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentsListPostRequest:
        """Test DocumentsListPostRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentsListPostRequest`
        """
        model = DocumentsListPostRequest()
        if include_optional:
            return DocumentsListPostRequest(
                offset = 1.337,
                limit = 25,
                sort = 'updatedAt',
                direction = 'DESC',
    ...
    def testDocumentsListPostRequest(self):
        """Test DocumentsListPostRequest"""
