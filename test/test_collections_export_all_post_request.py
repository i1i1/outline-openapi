...
class TestCollectionsExportAllPostRequest(unittest.TestCase):
    """CollectionsExportAllPostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CollectionsExportAllPostRequest:
        """Test CollectionsExportAllPostRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CollectionsExportAllPostRequest`
        """
        model = CollectionsExportAllPostRequest()
        if include_optional:
            return CollectionsExportAllPostRequest(
    ...
    def testCollectionsExportAllPostRequest(self):
        """Test CollectionsExportAllPostRequest"""
