...
class TestAttachmentsCreatePost200ResponseData(unittest.TestCase):
    """AttachmentsCreatePost200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AttachmentsCreatePost200ResponseData:
        """Test AttachmentsCreatePost200ResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AttachmentsCreatePost200ResponseData`
        """
        model = AttachmentsCreatePost200ResponseData()
        if include_optional:
            return AttachmentsCreatePost200ResponseData(
    ...
    def testAttachmentsCreatePost200ResponseData(self):
        """Test AttachmentsCreatePost200ResponseData"""
