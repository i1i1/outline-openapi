...
class TestViewsCreatePost200Response(unittest.TestCase):
    """ViewsCreatePost200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewsCreatePost200Response:
        """Test ViewsCreatePost200Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewsCreatePost200Response`
        """
        model = ViewsCreatePost200Response()
        if include_optional:
            return ViewsCreatePost200Response(
                data = openapi_client.models.view.View(
                    id = '', 
                    document_id = '', 
                    first_viewed_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
    ...
    def testViewsCreatePost200Response(self):
        """Test ViewsCreatePost200Response"""
