...
class TestDocumentsSearchPost200Response(unittest.TestCase):
    """DocumentsSearchPost200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentsSearchPost200Response:
        """Test DocumentsSearchPost200Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentsSearchPost200Response`
        """
        model = DocumentsSearchPost200Response()
        if include_optional:
            return DocumentsSearchPost200Response(
                data = [
                    openapi_client.models._documents_search_post_200_response_data_inner._documents_search_post_200_response_data_inner(
                ...
                policies = [
                    openapi_client.models.policy.Policy(
                        id = '', 
                        abilities = openapi_client.models.policy_abilities.Policy_abilities(
                            create = True, 
                            read = True, 
                            update = True, 
                            delete = True, 
    ...
    def testDocumentsSearchPost200Response(self):
        """Test DocumentsSearchPost200Response"""
