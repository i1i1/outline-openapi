...
class TestSharesApi(unittest.TestCase):
    ...
    def test_shares_create_post(self) -> None:
    ...
    def test_shares_info_post(self) -> None:
    ...
    def test_shares_list_post(self) -> None:
    ...
    def test_shares_revoke_post(self) -> None:
    ...
    def test_shares_update_post(self) -> None:
