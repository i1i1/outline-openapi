...
class TestCollectionsCreatePost200Response(unittest.TestCase):
    """CollectionsCreatePost200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CollectionsCreatePost200Response:
        """Test CollectionsCreatePost200Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CollectionsCreatePost200Response`
        """
        model = CollectionsCreatePost200Response()
        if include_optional:
            return CollectionsCreatePost200Response(
                data = openapi_client.models.collection.Collection(
                    id = '', 
                    name = 'Human Resources', 
                    description = '', 
                    sort = openapi_client.models.collection_sort.Collection_sort(
                        field = '', 
                        direction = 'asc', ), 
                    index = 'P', 
                    color = '#123123', 
    ...
    def testCollectionsCreatePost200Response(self):
        """Test CollectionsCreatePost200Response"""
