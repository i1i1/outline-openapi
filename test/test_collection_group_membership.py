...
class TestCollectionGroupMembership(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CollectionGroupMembership:
        """Test CollectionGroupMembership
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CollectionGroupMembership`
        """
        model = CollectionGroupMembership()
        if include_optional:
            return CollectionGroupMembership(
                id = '',
                group_id = '',
                collection_id = '',
                permission = 'read'
