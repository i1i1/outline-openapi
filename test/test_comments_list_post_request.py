...
class TestCommentsListPostRequest(unittest.TestCase):
    """CommentsListPostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CommentsListPostRequest:
        """Test CommentsListPostRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CommentsListPostRequest`
        """
        model = CommentsListPostRequest()
        if include_optional:
            return CommentsListPostRequest(
                offset = 1.337,
                limit = 25,
                sort = 'updatedAt',
                direction = 'DESC',
    ...
    def testCommentsListPostRequest(self):
        """Test CommentsListPostRequest"""
