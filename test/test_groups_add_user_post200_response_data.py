...
class TestGroupsAddUserPost200ResponseData(unittest.TestCase):
    """GroupsAddUserPost200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GroupsAddUserPost200ResponseData:
        """Test GroupsAddUserPost200ResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GroupsAddUserPost200ResponseData`
        """
        model = GroupsAddUserPost200ResponseData()
        if include_optional:
            return GroupsAddUserPost200ResponseData(
                users = [
    ...
    def testGroupsAddUserPost200ResponseData(self):
        """Test GroupsAddUserPost200ResponseData"""
