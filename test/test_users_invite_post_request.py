...
class TestUsersInvitePostRequest(unittest.TestCase):
    """UsersInvitePostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UsersInvitePostRequest:
        """Test UsersInvitePostRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UsersInvitePostRequest`
        """
        model = UsersInvitePostRequest()
        if include_optional:
            return UsersInvitePostRequest(
                invites = [
    ...
    def testUsersInvitePostRequest(self):
        """Test UsersInvitePostRequest"""
