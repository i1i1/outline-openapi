...
class TestGroupsMembershipsPostRequest(unittest.TestCase):
    """GroupsMembershipsPostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GroupsMembershipsPostRequest:
        """Test GroupsMembershipsPostRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GroupsMembershipsPostRequest`
        """
        model = GroupsMembershipsPostRequest()
        if include_optional:
            return GroupsMembershipsPostRequest(
                offset = 1.337,
                limit = 25,
    ...
    def testGroupsMembershipsPostRequest(self):
        """Test GroupsMembershipsPostRequest"""
