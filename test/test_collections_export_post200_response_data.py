...
class TestCollectionsExportPost200ResponseData(unittest.TestCase):
    """CollectionsExportPost200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CollectionsExportPost200ResponseData:
        """Test CollectionsExportPost200ResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CollectionsExportPost200ResponseData`
        """
        model = CollectionsExportPost200ResponseData()
        if include_optional:
            return CollectionsExportPost200ResponseData(
    ...
    def testCollectionsExportPost200ResponseData(self):
        """Test CollectionsExportPost200ResponseData"""
