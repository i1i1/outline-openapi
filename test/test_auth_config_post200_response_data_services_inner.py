...
class TestAuthConfigPost200ResponseDataServicesInner(unittest.TestCase):
    """AuthConfigPost200ResponseDataServicesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AuthConfigPost200ResponseDataServicesInner:
        """Test AuthConfigPost200ResponseDataServicesInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuthConfigPost200ResponseDataServicesInner`
        """
        model = AuthConfigPost200ResponseDataServicesInner()
        if include_optional:
            return AuthConfigPost200ResponseDataServicesInner(
                id = 'slack',
                name = 'Slack',
    ...
    def testAuthConfigPost200ResponseDataServicesInner(self):
        """Test AuthConfigPost200ResponseDataServicesInner"""
