...
class TestCommentsCreatePost200Response(unittest.TestCase):
    """CommentsCreatePost200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CommentsCreatePost200Response:
        """Test CommentsCreatePost200Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CommentsCreatePost200Response`
        """
        model = CommentsCreatePost200Response()
        if include_optional:
            return CommentsCreatePost200Response(
                data = openapi_client.models.comment.Comment(
                    ...
                    updated_by = openapi_client.models.user.User(
                        id = '', 
                        name = 'Jane Doe', 
                        avatar_url = '', 
                        email = '', 
    ...
    def testCommentsCreatePost200Response(self):
        """Test CommentsCreatePost200Response"""
