...
class TestGroupsRemoveUserPost200ResponseData(unittest.TestCase):
    """GroupsRemoveUserPost200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GroupsRemoveUserPost200ResponseData:
        """Test GroupsRemoveUserPost200ResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GroupsRemoveUserPost200ResponseData`
        """
        model = GroupsRemoveUserPost200ResponseData()
        if include_optional:
            return GroupsRemoveUserPost200ResponseData(
                groups = [
    ...
    def testGroupsRemoveUserPost200ResponseData(self):
        """Test GroupsRemoveUserPost200ResponseData"""
