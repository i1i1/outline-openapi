...
class TestRevisionsInfoPostRequest(unittest.TestCase):
    """RevisionsInfoPostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RevisionsInfoPostRequest:
        """Test RevisionsInfoPostRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RevisionsInfoPostRequest`
        """
        model = RevisionsInfoPostRequest()
        if include_optional:
            return RevisionsInfoPostRequest(
                id = ''
            )
        else:
            return RevisionsInfoPostRequest(
    ...
    def testRevisionsInfoPostRequest(self):
        """Test RevisionsInfoPostRequest"""
