...
class TestAttachmentsRedirectPostRequest(unittest.TestCase):
    """AttachmentsRedirectPostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AttachmentsRedirectPostRequest:
        """Test AttachmentsRedirectPostRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AttachmentsRedirectPostRequest`
        """
        model = AttachmentsRedirectPostRequest()
        if include_optional:
            return AttachmentsRedirectPostRequest(
                id = ''
            )
        else:
            return AttachmentsRedirectPostRequest(
    ...
    def testAttachmentsRedirectPostRequest(self):
        """Test AttachmentsRedirectPostRequest"""
