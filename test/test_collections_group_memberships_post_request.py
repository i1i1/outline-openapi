...
class TestCollectionsGroupMembershipsPostRequest(unittest.TestCase):
    """CollectionsGroupMembershipsPostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CollectionsGroupMembershipsPostRequest:
        """Test CollectionsGroupMembershipsPostRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CollectionsGroupMembershipsPostRequest`
        """
        model = CollectionsGroupMembershipsPostRequest()
        if include_optional:
            return CollectionsGroupMembershipsPostRequest(
                offset = 1.337,
                limit = 25,
                id = '',
                query = 'developers',
    ...
    def testCollectionsGroupMembershipsPostRequest(self):
        """Test CollectionsGroupMembershipsPostRequest"""
