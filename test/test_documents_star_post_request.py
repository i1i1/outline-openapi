...
class TestDocumentsStarPostRequest(unittest.TestCase):
    """DocumentsStarPostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentsStarPostRequest:
        """Test DocumentsStarPostRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentsStarPostRequest`
        """
        model = DocumentsStarPostRequest()
        if include_optional:
            return DocumentsStarPostRequest(
                id = 'hDYep1TPAM'
            )
        else:
            return DocumentsStarPostRequest(
    ...
    def testDocumentsStarPostRequest(self):
        """Test DocumentsStarPostRequest"""
