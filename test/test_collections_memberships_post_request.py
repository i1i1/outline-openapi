...
class TestCollectionsMembershipsPostRequest(unittest.TestCase):
    """CollectionsMembershipsPostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CollectionsMembershipsPostRequest:
        """Test CollectionsMembershipsPostRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CollectionsMembershipsPostRequest`
        """
        model = CollectionsMembershipsPostRequest()
        if include_optional:
            return CollectionsMembershipsPostRequest(
                offset = 1.337,
                limit = 25,
                id = '',
                query = 'jenny',
    ...
    def testCollectionsMembershipsPostRequest(self):
        """Test CollectionsMembershipsPostRequest"""
