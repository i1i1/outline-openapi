...
class TestGroupsUpdatePostRequest(unittest.TestCase):
    """GroupsUpdatePostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GroupsUpdatePostRequest:
        """Test GroupsUpdatePostRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GroupsUpdatePostRequest`
        """
        model = GroupsUpdatePostRequest()
        if include_optional:
            return GroupsUpdatePostRequest(
                id = '',
                name = 'Designers'
            )
        else:
    ...
    def testGroupsUpdatePostRequest(self):
        """Test GroupsUpdatePostRequest"""
