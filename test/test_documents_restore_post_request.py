...
class TestDocumentsRestorePostRequest(unittest.TestCase):
    """DocumentsRestorePostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentsRestorePostRequest:
        """Test DocumentsRestorePostRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentsRestorePostRequest`
        """
        model = DocumentsRestorePostRequest()
        if include_optional:
            return DocumentsRestorePostRequest(
                id = 'hDYep1TPAM',
                revision_id = ''
            )
        else:
    ...
    def testDocumentsRestorePostRequest(self):
        """Test DocumentsRestorePostRequest"""
