...
class TestCollectionsUpdatePostRequest(unittest.TestCase):
    """CollectionsUpdatePostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CollectionsUpdatePostRequest:
        """Test CollectionsUpdatePostRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CollectionsUpdatePostRequest`
        """
        model = CollectionsUpdatePostRequest()
        if include_optional:
            return CollectionsUpdatePostRequest(
                id = '',
    ...
    def testCollectionsUpdatePostRequest(self):
        """Test CollectionsUpdatePostRequest"""
