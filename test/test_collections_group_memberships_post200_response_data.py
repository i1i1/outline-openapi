...
class TestCollectionsGroupMembershipsPost200ResponseData(unittest.TestCase):
    """CollectionsGroupMembershipsPost200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CollectionsGroupMembershipsPost200ResponseData:
        """Test CollectionsGroupMembershipsPost200ResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CollectionsGroupMembershipsPost200ResponseData`
        """
        model = CollectionsGroupMembershipsPost200ResponseData()
        if include_optional:
            return CollectionsGroupMembershipsPost200ResponseData(
                groups = [
    ...
    def testCollectionsGroupMembershipsPost200ResponseData(self):
        """Test CollectionsGroupMembershipsPost200ResponseData"""
