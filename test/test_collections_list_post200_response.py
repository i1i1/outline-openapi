...
class TestCollectionsListPost200Response(unittest.TestCase):
    """CollectionsListPost200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CollectionsListPost200Response:
        """Test CollectionsListPost200Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CollectionsListPost200Response`
        """
        model = CollectionsListPost200Response()
        if include_optional:
            return CollectionsListPost200Response(
                data = [
    ...
    def testCollectionsListPost200Response(self):
        """Test CollectionsListPost200Response"""
