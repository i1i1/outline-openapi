...
class TestFileOperationsListPost200Response(unittest.TestCase):
    """FileOperationsListPost200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FileOperationsListPost200Response:
        """Test FileOperationsListPost200Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FileOperationsListPost200Response`
        """
        model = FileOperationsListPost200Response()
        if include_optional:
            return FileOperationsListPost200Response(
                data = [
                    openapi_client.models.file_operation.FileOperation(
                        id = '', 
                        type = 'export', 
                        state = 'complete', 
                        collection = null, 
    ...
    def testFileOperationsListPost200Response(self):
        """Test FileOperationsListPost200Response"""
