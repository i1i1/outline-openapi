...
class TestDocumentsDraftsPostRequest(unittest.TestCase):
    """DocumentsDraftsPostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentsDraftsPostRequest:
        """Test DocumentsDraftsPostRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentsDraftsPostRequest`
        """
        model = DocumentsDraftsPostRequest()
        if include_optional:
            return DocumentsDraftsPostRequest(
                offset = 1.337,
                limit = 25,
                sort = 'updatedAt',
                direction = 'DESC',
    ...
    def testDocumentsDraftsPostRequest(self):
        """Test DocumentsDraftsPostRequest"""
