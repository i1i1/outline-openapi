...
class TestSharesCreatePostRequest(unittest.TestCase):
    """SharesCreatePostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SharesCreatePostRequest:
        """Test SharesCreatePostRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SharesCreatePostRequest`
        """
        model = SharesCreatePostRequest()
        if include_optional:
            return SharesCreatePostRequest(
                document_id = ''
            )
        else:
            return SharesCreatePostRequest(
    ...
    def testSharesCreatePostRequest(self):
        """Test SharesCreatePostRequest"""
