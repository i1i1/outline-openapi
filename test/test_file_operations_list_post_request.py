...
class TestFileOperationsListPostRequest(unittest.TestCase):
    """FileOperationsListPostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FileOperationsListPostRequest:
        """Test FileOperationsListPostRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FileOperationsListPostRequest`
        """
        model = FileOperationsListPostRequest()
        if include_optional:
            return FileOperationsListPostRequest(
                offset = 1.337,
                limit = 25,
                sort = 'updatedAt',
                direction = 'DESC',
    ...
    def testFileOperationsListPostRequest(self):
        """Test FileOperationsListPostRequest"""
