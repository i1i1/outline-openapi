...
class TestEventsListPostRequest(unittest.TestCase):
    """EventsListPostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EventsListPostRequest:
        """Test EventsListPostRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EventsListPostRequest`
        """
        model = EventsListPostRequest()
        if include_optional:
            return EventsListPostRequest(
                offset = 1.337,
                limit = 25,
                sort = 'updatedAt',
                direction = 'DESC',
    ...
    def testEventsListPostRequest(self):
        """Test EventsListPostRequest"""
