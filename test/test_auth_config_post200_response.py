...
class TestAuthConfigPost200Response(unittest.TestCase):
    """AuthConfigPost200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AuthConfigPost200Response:
        """Test AuthConfigPost200Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuthConfigPost200Response`
        """
        model = AuthConfigPost200Response()
        if include_optional:
            return AuthConfigPost200Response(
                data = openapi_client.models._auth_config_post_200_response_data._auth_config_post_200_response_data(
                    name = 'Acme Inc', 
                    hostname = 'acme-inc.getoutline.com', 
                    services = [
                        openapi_client.models._auth_config_post_200_response_data_services_inner._auth_config_post_200_response_data_services_inner(
                            id = 'slack', 
                            name = 'Slack', 
                            auth_url = 'https://acme-inc.getoutline.com/auth/slack', )
                        ], )
            )
        else:
            return AuthConfigPost200Response(
    ...
    def testAuthConfigPost200Response(self):
        """Test AuthConfigPost200Response"""
