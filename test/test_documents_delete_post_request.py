...
class TestDocumentsDeletePostRequest(unittest.TestCase):
    """DocumentsDeletePostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentsDeletePostRequest:
        """Test DocumentsDeletePostRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentsDeletePostRequest`
        """
        model = DocumentsDeletePostRequest()
        if include_optional:
            return DocumentsDeletePostRequest(
                id = 'hDYep1TPAM',
                permanent = False
            )
        else:
    ...
    def testDocumentsDeletePostRequest(self):
        """Test DocumentsDeletePostRequest"""
