...
class TestCollectionsAddUserPost200ResponseData(unittest.TestCase):
    """CollectionsAddUserPost200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CollectionsAddUserPost200ResponseData:
        """Test CollectionsAddUserPost200ResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CollectionsAddUserPost200ResponseData`
        """
        model = CollectionsAddUserPost200ResponseData()
        if include_optional:
            return CollectionsAddUserPost200ResponseData(
                users = [
    ...
    def testCollectionsAddUserPost200ResponseData(self):
        """Test CollectionsAddUserPost200ResponseData"""
