...
class TestCollectionsAddUserPostRequest(unittest.TestCase):
    """CollectionsAddUserPostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CollectionsAddUserPostRequest:
        """Test CollectionsAddUserPostRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CollectionsAddUserPostRequest`
        """
        model = CollectionsAddUserPostRequest()
        if include_optional:
            return CollectionsAddUserPostRequest(
                id = '',
                user_id = '',
                permission = 'read'
            )
    ...
    def testCollectionsAddUserPostRequest(self):
        """Test CollectionsAddUserPostRequest"""
