...
class TestGroupsAddUserPostRequest(unittest.TestCase):
    """GroupsAddUserPostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GroupsAddUserPostRequest:
        """Test GroupsAddUserPostRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GroupsAddUserPostRequest`
        """
        model = GroupsAddUserPostRequest()
        if include_optional:
            return GroupsAddUserPostRequest(
                id = '',
                user_id = ''
            )
        else:
    ...
    def testGroupsAddUserPostRequest(self):
        """Test GroupsAddUserPostRequest"""
