...
class TestDocumentsSearchPostRequest(unittest.TestCase):
    """DocumentsSearchPostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentsSearchPostRequest:
        """Test DocumentsSearchPostRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentsSearchPostRequest`
        """
        model = DocumentsSearchPostRequest()
        if include_optional:
            return DocumentsSearchPostRequest(
                offset = 1.337,
                limit = 25,
                query = 'hiring',
                user_id = '',
    ...
    def testDocumentsSearchPostRequest(self):
        """Test DocumentsSearchPostRequest"""
