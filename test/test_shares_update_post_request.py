...
class TestSharesUpdatePostRequest(unittest.TestCase):
    """SharesUpdatePostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SharesUpdatePostRequest:
        """Test SharesUpdatePostRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SharesUpdatePostRequest`
        """
        model = SharesUpdatePostRequest()
        if include_optional:
            return SharesUpdatePostRequest(
                id = '',
                published = True
            )
        else:
    ...
    def testSharesUpdatePostRequest(self):
        """Test SharesUpdatePostRequest"""
