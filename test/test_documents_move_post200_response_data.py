...
class TestDocumentsMovePost200ResponseData(unittest.TestCase):
    """DocumentsMovePost200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentsMovePost200ResponseData:
        """Test DocumentsMovePost200ResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentsMovePost200ResponseData`
        """
        model = DocumentsMovePost200ResponseData()
        if include_optional:
            return DocumentsMovePost200ResponseData(
                documents = [
    ...
    def testDocumentsMovePost200ResponseData(self):
        """Test DocumentsMovePost200ResponseData"""
